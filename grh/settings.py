...
# SECRET_KEY = 'django-insecure-a^c+ylq$h46l5#*(_*exhl4tios*ezh5+3!1=y%74l93*x9!42'
...
# }
DATABASES = {
    'default': dj_database_url.parse(config('BATABASES_URL')),
        }
